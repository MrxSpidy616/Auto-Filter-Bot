...
if len(API_HASH) == 0:
    ...
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', "7794476710:AAHHoYxU0oAS9CBufqlkBjgLk2k0vS482qs") #bot token from botfather
if len(BOT_TOKEN) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', "1039959953") #apni tg id daalo
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', "-1002186622111").split()]
...
LOG_CHANNEL = environ.get('LOG_CHANNEL', "-1002284057255") #bot log channel -1005293546253
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://frosthzmrspidyxd616:9e2JTnNAKMGVO2dE@cluster0.vhy397y.mongodb.net/?retryWrites=true&w=majority") #mongo db url
if len(DATABASE_URL) == 0:
    print('Error - DATABASE_URL is missing, exiting now')
    exit()
DATABASE_NAME = environ.get('DATABASE_NAME', "SpidyFS")
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002284057255") #if is_stream = true then add a channel id ex: -10026393639
